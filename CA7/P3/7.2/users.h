...
public:
    ...
    virtual std::vector <Trip*> show_all_trips(std::vector <Trip*> trips, std::string sorted_by_cost) = 0;
    virtual Trip* show_specefic_trips(std::vector <Trip*> trips, int id) = 0;
    int get_trip_id();
